package com.king.functions.excel.Reflection;
...
//        filed.put("sex", "男");
//        try {
//            Object dynamicObject = dynamicCreateObject.getDynamicObject("Student", filed);
//            System.out.println(dynamicCreateObject.getFieldValue(dynamicObject, "name"));
//            System.out.println(dynamicCreateObject.getFieldValue(dynamicObject, "sex"));
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
    }
