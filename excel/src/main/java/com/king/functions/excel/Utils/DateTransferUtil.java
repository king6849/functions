...
public class DateTransferUtil {
    ...
    public static void main(String[] args) {
        DateTransferUtil dateTransferUtil = new DateTransferUtil();
        String string = dateTransferUtil.transferDateToString(new Date(System.currentTimeMillis()), "yyyy年MM月dd日");
